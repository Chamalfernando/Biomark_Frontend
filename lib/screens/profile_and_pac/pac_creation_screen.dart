            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) => validateTimeOfBirth(value as TimeOfDay),
                ),
                boxSIZED_20,
                // Location of Birth
                TextFormField(
                ...
                //   decoration: InputDecoration(
                //     labelText: "Height (in Feet and Inches)",
                //     fillColor: primaryGreen,
                //     filled: true,
                //     border: OutlineInputBorder(
                //       borderRadius: BorderRadius.circular(10),
                //     ),
                //   ),
                //   validator: (value) => validateHeight(value as double),
                // ),
                HeightPicker(),
                boxSIZED_20,
                // Ethnicity Dropdown
                DropdownButtonFormField<String>(
                  ...
                  items: ['Sinhalese', 'Tamil', 'Muslim', 'Other']
                      .map((ethnicity) => DropdownMenuItem<String>(
                            value: ethnicity,
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Brown', 'Blue', 'Green', 'Gray', 'Hazel', 'Amber']
                      .map((eyeColor) => DropdownMenuItem<String>(
                            value: eyeColor,
                            child: Text(eyeColor),
                          ))
                      .toList(),
...
class _HeightPickerState extends State<HeightPicker> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text('Height (in Feet and Inches)', style: TextStyle(fontSize: 16)),
        Row(
          ...
          children: [
            ...
            Expanded(
              child: DropdownButtonFormField<int>(
                ...
                items: inchOptions.map((int value) {
                  return DropdownMenuItem<int>(
                    value: value,
                    child: Text('$value'),
                  );
